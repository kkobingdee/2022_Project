...
void AES_DEC(u8 CT[16], u8 RK[16], u8 PT2[16], int keysize) {
	int Nr = keysize / 32 + 6;
	int i;
	u8 temp[16];
...
int main() {
	u8 PT[16] = { 0x4D, 0x9B, 0x9E, 0xA0, 0x10, 0xA4, 0x57, 0xAD, 0xB7, 0x76, 0xEE, 0x46, 0x09, 0x99, 0x49, 0x7B };//평문
