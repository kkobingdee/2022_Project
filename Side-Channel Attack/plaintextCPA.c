...
#define _FOLD_ "C:\\Users\\부채널분석1\\Desktop\\SCAAML\\"   
#define TraceFN "2022.03.25-05.40.47_traces.npy.bak"  
#define AlignedTraceFN "trace.bin"
#define PlaintextFN "2022.03.25-05.40.47_textin.npy"
...
void plaintextCPA() {
    unsigned char** plaintext = NULL;    double** data;    char buf[256];
    int err, TraceLength = 24000, TraceNum = 10000, i, j, key, k, maxkey;
    FILE* rfp, * wfp;
    ...
    for (int b = 0; b < 16; b++) {
        ...
        sprintf_s(buf, 256 * sizeof(char), "%splaintextCPA\\cpa%02d.corrtrace", _FOLD_, b);
